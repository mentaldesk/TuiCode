...
- Keys needing a capable terminal: `Shift+Enter` (previous match) and the `Ctrl+Shift+letter` chords (collapse onto `Ctrl+letter` in Terminal.app — the `ss`/`sr`/`se` mnemonics always work).
