...
public class CompareToSavedHostTests : StaticConfigurationTest
{
    ...
    private const string ThreeChangesStatus = "a.txt ↔ saved  •  Change {0} of 3  •  Alt+↓ next  Alt+↑ prev  Enter go to line";
    ...
    public async Task The_status_hint_follows_a_rebind_and_clears_when_the_diff_tab_loses_focus()
    {
        ...
        Assert.Equal("a.txt ↔ saved  •  Change 1 of 3  •  F8 next  Alt+↑ prev  Enter go to line", rebound);
    }
